...
### flaci parser
If you don't want to encode the turing machine by hand, you can use the flaci parser.
The Flaci parser is specifically designed to parse JSON savefiles used by Flaci. To use the parser, follow these steps:
